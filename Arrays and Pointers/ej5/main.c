...
// claramente funciona mucho mas rapido que la version sin punteros, pues porque los punteros ayudan a que se haga directamente el cambio con los respectivos -
// parametros haciendo que el tiempo de ejecucion sea mas corto.
//se llama a destroy pra una vez utilizado el parametro de tipo puntero se destruya ya que no se va a utilizar mas, pues este ocupa lugar en la memoria entoces estariamos favoreciendo a la misma con la desruccion.
// en caso de no hacerlo pus pasaria que habria memeoria que quizas necesitemos ocupada por algo que no esta siendo usado o no tiene gran relevacia. 